package com.example.buoi7_cn.ui.view

import android.graphics.drawable.Drawable
import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import com.example.buoi7_cn.R
import com.example.buoi7_cn.databinding.ActivityLichDetailBinding
...
class LichDetailActivity : AppCompatActivity() {
    ...
    private fun displayLichDetail(bundle: Bundle) {
        ...
        val hoVaTen = com.example.buoi7_cn.utils.BundleHelper.getHoVaTen(bundle)
        val ngayGio = com.example.buoi7_cn.utils.BundleHelper.getNgayGio(bundle)
        val noiDung = com.example.buoi7_cn.utils.BundleHelper.getNoiDung(bundle)
        val linkAnh = com.example.buoi7_cn.utils.BundleHelper.getLinkAnh(bundle)
